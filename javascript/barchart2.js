d3.csv("./data/salary.csv", function (error, salaryData) {
    ...
    var salarySvg = d3.select("#salarySvg")
        .attr("width", salaryChartWidth + salaryChartMargin.left + salaryChartMargin.right)
        .attr("height", salaryChartHeight + salaryChartMargin.top + salaryChartMargin.bottom)
        .append("g")
        .attr("transform",
            "translate(" + salaryChartMargin.left + "," + salaryChartMargin.top + ")");
    ...
    var salaryTip = d3.tip()
        ...
        .offset([-10, 0])
        .html(function (d) {
            if(d.degree == "大學") return d.degree + " : <span style='color:orange'>" + d.pay + "</span> 元";
